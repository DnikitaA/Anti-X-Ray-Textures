...
class ThreadConnectToServer extends Thread
{
    ...
    public void run()
    {
/*______________________________________Check Texture Pack________________________________________*/
    	if(!ProtectionTextures.CheckAlpha(mc))
    	{
            ...
            mc.displayGuiScreen(new GuiDisconnected("connect.failed", "disconnect.genericReason", new Object[]
                    {
            		(new StringBuilder()).append("'You use X-Ray Texture pack.Cheater!!!!'").toString()
                    }));
    	}
